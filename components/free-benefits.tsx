import { Gift, Wifi, Headphones, Clock } from 'lucide-react';
  ...
  const benefits = [
    {
      ...
      description:
        'Economize até R$ 200,00! Nossa equipe instala tudo sem custo adicional.',
      highlight: 'R$ 0,00',
    },
    {
      icon: Wifi,
      title: 'Equipamentos Inclusos',
      description: 'Roteador Wi-Fi de alta performance em comodato gratuito.',
      highlight: 'Grátis',
    },
    {
      icon: Headphones,
      title: 'Suporte 24/7',
      description:
        'Atendimento técnico especializado disponível todos os dias.',
      highlight: '24h',
    },
    {
      icon: Clock,
      ...
      description:
        'Sem taxas de ativação ou configuração. Conecte-se hoje mesmo!',
      highlight: 'Hoje',
    },
  ];
      ...
      <div className='container mx-auto px-4 relative z-10'>
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed'>
            Na INFO-TEC, você não paga nada além da mensalidade.
            <span className='font-bold text-[#fc842b]'>
              {' '}
              Zero taxas, zero pegadinhas!
            </span>
          </p>
        </div>
          ...
          <div className='bg-gradient-to-r from-[#fc842b] to-[#e07525] rounded-2xl p-8 max-w-4xl mx-auto shadow-2xl relative overflow-hidden'>
            ...
            <div className='relative z-10'>
              <h3 className='text-3xl font-bold text-white mb-4'>
                Pronto para economizar e ter a melhor internet?
              </h3>
              <p className='text-xl text-white opacity-90 mb-6'>
                Não perca tempo! Contrate agora e tenha instalação gratuita hoje
                mesmo.
              </p>
